const ACADEMY_QUESTIONS = [
  {
    ...
    options: [
      { id: "A", text: "Remaining FMLA entitlement", correct: false },
      { id: "B", text: "FMLA eligibility requirements", correct: true },
      { id: "C", text: "Whether the employee used PTO", correct: false },
      { id: "D", text: "Whether the employee prefers intermittent leave", correct: false }
    ],
    correctFeedback:
  ...
  },
  {
    ...
    calculation: {
      inputs: [
        { label: "Regular hours actually worked", value: 1180, counts: true },
        { label: "Overtime actually worked", value: 74, counts: true },
        { label: "PTO", value: 80, counts: false },
        { label: "Sick leave", value: 32, counts: false },
        { label: "Holiday not worked", value: 16, counts: false }
      ],
      expectedAnswer: 1254
    },
    correctFeedback:
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "0.050 workweek", correct: false },
      { id: "B", text: "0.100 workweek", correct: true },
      { id: "C", text: "0.125 workweek", correct: false },
      { id: "D", text: "1.000 workweek", correct: false }
    ],
    correctFeedback:
